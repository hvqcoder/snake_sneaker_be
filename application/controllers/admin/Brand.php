...
class Brand extends CI_Controller {
    ...
    function addForm()
    {
        ...
        $this->form_validation->set_rules('category_id[]', $this->lang->line('select_cat_lbl'), 'trim|required');
        ...
        if($this->form_validation->run() == FALSE)
        {
            ...
            if(isset($_GET['redirect'])){
                redirect(base_url('admin/brand/add?redirect='.$_GET['redirect']), 'refresh');
            }
            else{
