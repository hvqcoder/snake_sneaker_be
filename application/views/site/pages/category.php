    ...
    <div class="row"> 
      <?php 
        ...
        foreach ($category_list as $key => $row) 
        {
          ...
          $img_file=base_url().$ci->_generate_thumbnail('assets/images/category/',$thumb_img_nm,$row->category_image,270,162);
        ...
        <div class="single-offer">
          <div class="all_categori_list img-full"> 
            <a href="<?=$url?>" title="<?=$row->category_name?>">          
              <img src="<?=$img_file?>" alt="<?=$row->category_name?>" title="<?=$row->category_name?>"> 
