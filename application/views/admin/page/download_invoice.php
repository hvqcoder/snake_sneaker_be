			...
			<main>
				<div class="row contacts">
					<div class="col-md-6 invoice-to">
						...
						<h3 class="to"><?php echo $this->common_model->selectByidParam($order_details->user_id, 'tbl_users','user_name');?></h3>
						<div class="address">
							...
							foreach ($order_items as $key => $val) {
								...
								<tr>
									...
									<td class="qty" align="center" <?=$apply_css?>>
										<?php echo CURRENCY_CODE.' '.$this->common_model->selectByidParam($val->product_id, 'tbl_product','product_mrp');?>
									</td>
									<td class="qty" align="center" <?=$apply_css?>>
										<?=$this->common_model->selectByidParam($val->product_id, 'tbl_product','product_mrp')-$val->product_price?>
									</td>
