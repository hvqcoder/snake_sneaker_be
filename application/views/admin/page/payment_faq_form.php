  ...
  <div class="col-md-12">
    ...
    <div class="card">
      ...
      <div class="card-body mrg_bottom"> 
        <form action="<?php if(!isset($faq_row)){ echo site_url('admin/pages/add_payment_faq').'?redirect='.$redirect; }else{  echo site_url('admin/pages/edit_payment_faq/'.$faq_row->id).'?redirect='.$redirect; } ?>" method="post" id="categoryForm" class="form form-horizontal" enctype="multipart/form-data">
          <div class="section">
                ...
                <div class="content">
                  <div class="content_holder">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-6">
                        <textarea name="faq_answer[]" required="" placeholder="<?=$this->lang->line('answer_place_lbl')?>" class="form-control faq_answer" rows="5"><?=(isset($faq_row)) ? $faq_row->faq_answer : '';?></textarea>
                      </div>
                    </div>
                    <div class="form-group">
