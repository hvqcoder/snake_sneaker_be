               ...
               <pre>
                <code class="html">               
                    ...
                    <div style="border: 2px solid #FFF;padding: 10px 15px;border-radius:4px;"><p style="font-size:16px;font-weight:600">ALL ORDER APIS</p><b>Order Summary</b> (URL: <?=$file_path?>order_summary) (Parameters: user_id, buy_now[true, false], product_id, product_size, device_id)
                        <br><b>Order Details</b> (URL: <?=$file_path?>order_detail) (Parameters: order_unique_id, product_id)
                    ...
                    <div style="border: 2px solid #FFF;padding: 10px 15px;border-radius:4px;"><p style="font-size:16px;font-weight:600">ALL PAYMENT RELATED APIS</p><br><b>Get Payable Amount</b> (URL: <?=$file_path?>get_payable_amount) (Parameters: user_id, cart_ids, cart_type[main_cart/temp_cart])
                        <br><b>Generate Braintree Payable Amount</b> (URL: <?=$file_path?>generate_braintree_amount) (Parameters: user_id, cart_ids, cart_type[main_cart/temp_cart])
                        <br><b>Generate Paystack Payable Amount</b> (URL: <?=$file_path?>generate_paystack_amount) (Parameters: user_id, cart_ids, address_id, cart_type[main_cart/temp_cart])
                        ...
                        <br><span><b>Generate Braintree Payment ID</b> (URL: <?=$file_path?>generate_braintree_payment) (Parameters: nonce, user_id, cart_ids, cart_type[main_cart/temp_cart])</span>
                    </div>
                    ...
                    <div style="border: 2px solid #FFF;padding: 10px 15px;border-radius:4px;"><p style="font-size:16px;font-weight:600">ALL FILTER APIS</p><b>Get Filter List</b> (URL: <?=$file_path?>filter_list) (Parameters: type[banner, brand, offer, today_deal, recent_viewed_products, search, productList_cat, productList_cat_sub, latest_products, top_rated_products], id, sort, keyword, user_id)</span>
                        ...
                        <br><b>Brand Filter</b> (URL: <?=$file_path?>brand_filter) (Parameters: type[banner, brand, offer, today_deal, recent_viewed_products, search, productList_cat, productList_cat_sub, latest_products, top_rated_products], id, keyword, user_id, brand_ids, sizes)</span>
