...
<head>
  ...
  <link rel="stylesheet" href="<?=base_url('assets/vendor/duDialog-master/duDialog.min.css')?>">
  <script src="<?=base_url('assets/vendor/duDialog-master/duDialog.min.js')?>"></script>

  <link rel="stylesheet" href="<?=base_url('assets/vendor/myalert/css/myalert.min.css')?>">
  <link rel="stylesheet" href="<?=base_url('assets/vendor/myalert/css/myalert-theme.min.css')?>">
          ...
          <div class="container-fluid">
            <div class="navbar-collapse collapse in">
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown profile"> <a href="<?=site_url('admin/profile')?>" class="dropdown-toggle" data-toggle="dropdown"> <?php if(PROFILE_IMG){?>               
                  <img class="profile-img" src="<?=base_url('assets/images/').PROFILE_IMG?>">
                <?php }else{?>
                  <img class="profile-img" src="<?=base_url('assets/images/profile.png')?>">
                <?php }?>
