...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2021 at 07:31 AM
...
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'user.viaviweb@gmail.com', '29102020094838_89371_24092019015612_71951_user.png');
...
CREATE TABLE `tbl_settings` (
  ...
  `braintree_status` varchar(30) NOT NULL DEFAULT 'false',
  `braintree_mode` varchar(10) NOT NULL,
  `braintree_pubic_key` varchar(150) NOT NULL,
  `braintree_private_key` text NOT NULL,
  `braintree_merchant_id` varchar(150) NOT NULL,
  `braintree_merchant_account_id` varchar(150) NOT NULL,
  `paystack_status` varchar(30) NOT NULL DEFAULT 'false',
  `paystack_pubic_key` text NOT NULL,
  ...
  `delete_instruction` longtext NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
(27, 11, 'Hair Care And Accessorys', 'hair-care-and-accessorys', '23012020050156_59241.jpg', '1579779116', 1, 1);
