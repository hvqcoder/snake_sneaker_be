                      ...
                      <form action="index.php?step=0" method="POST">
                        ...
                        <div class="field">
                          <label class="label">Envato Username
                              <p class="control-label-help" style="font-weight: 600;">https://codecanyon.net/user/<u style="color: #e91e63">viaviwebtech</u></p>
                              <p class="control-label-help" style="font-weight: 600;">(<u style="color: #e91e63">viaviwebtech</u> is username. Write your envato <u style="color: #e91e63">username</u>)</p>
                          </label>
                          <div class="control">
                        ...
                        <div class="field">
                          <label class="label">Envato Purchase Code :-
                            <p class="control-label-help" style="font-weight: 600;">(<a href="https://help.market.envato.com/hc/en-us/articles/202822600-Where-Is-My-Purchase-Code" target="_blank">Where Is My Purchase Code?</a>)</p>
                          </label>
                          <div class="control">
                ...
                <?php
                  if($_POST && isset($_POST["lcscs"])){
                    ...
                    <form action="index.php?step=1" method="POST">
                      ...
                      <div class="field">
                        <label class="label">Database Host
                          <p class="control-label-help" style="font-weight: 600;">Default Host: <u style="color: #e91e63">localhost</u></p>
                        </label>
                        <div class="control">
                          <input class="input" type="text" id="host" placeholder="enter your database host" name="host" required>
                        </div>
